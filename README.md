...
| [macOS](https://en.wikipedia.org/wiki/MacOS)                         | [Homebrew](https://brew.sh)]                       | [intermodal](https://formulae.brew.sh/formula/intermodal)                                         | `brew install intermodal`                                                             |
...
| [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows)           | [Scoop](https://scoop.sh)                          | [intermodal](https://github.com/ScoopInstaller/Main/blob/master/bucket/intermodal.json)           | `scoop install intermodal`                                                            |
